...
• 相关理论: 半音趋近音（Chromatic Approach Notes）`,
  ...
  },
  {
    ...
    key: 'A',
    bpm: 90,
    description: `在 Blues 中无缝切换大小调是现代吉他手常用的高级技巧。\n\n【详细解释】\n这个技巧的核心是在同一个 Solo 中混合使用小调五声音阶和大调五声音阶。小调五声音阶带来经典的“忧郁”感，而大调五声音阶则增添了“甜美”、“快乐”的色彩。通过在两者之间切换，可以极大地丰富 Solo 的情感层次。例如，在 A Blues 中，你可以使用 A 小调五声音阶（A-C-D-E-G）和 A 大调五声音阶（A-B-C#-E-F#）。\n\n【技术要点】\n• 熟悉小调和大调五声音阶在指板上的位置。\n• 关键在于找到两个音阶的共同音或平滑连接点。\n• 通常在 I 级和弦上使用大调五声音阶，在 IV、V 级和弦上切换回小调五声音阶。\n• 尝试将大调音阶的音符作为经过音，连接小调音阶的乐句。\n\n【学习资源】\n• YouTube: "Mixing Major and Minor Pentatonics" by Tim Pierce\n• 推荐视频: https://www.youtube.com/results?search_query=mixing+major+and+minor+pentatonic+blues\n• 经典曲目参考: The Allman Brothers Band "Jessica"`,
    audioTips: '在 I 级和弦上尝试大调音阶，IV、V 级和弦回归小调',
    tabs: [
      // A Minor Pentatonic part
      { string: 2, fret: 8, duration: 0.25 },
      { string: 2, fret: 5, duration: 0.25 },
      // Switch to A Major Pentatonic
      { string: 3, fret: 6, duration: 0.25 }, // C# (Major 3rd)
      { string: 3, fret: 4, duration: 0.25 }, // B (Major 2nd)
      { string: 4, fret: 7, duration: 0.5 }   // A (Root)
    ]
  }
];
