...
/**
 * 节奏训练组件
 * @param {Array} rhythmPatterns - 节奏型配置数组
 * @param {number} bpm - 节拍速度
 * @param {Function} setBpm - 设置节拍速度的函数
 * @param {boolean} isMetronomeActive - 节拍器是否激活
 * @param {Function} setIsMetronomeActive - 设置节拍器激活状态的函数
 */
const RhythmPractice = ({
  ...
  const [selectedPattern, setSelectedPattern] = useState('shuffle');
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6">
        {rhythmPatterns.map(pattern => (
          ...
          >
            ...
            <div className="text-2xl md:text-3xl mb-2 font-mono">{pattern.pattern}</div>
